...
$IP = (Get-NetIPAddress -AddressFamily IPv4 | Where {$_.IPAddress -like "10.0.*"} | Select-Object -First 1).IPAddress
Lisa-Tulemus "Baasvork" "IP aadress kujul 10.0.xxx.10" (Testi ($IP -like "10.0.*.10"))
...
if($License){
    ...
    $Grace = $License.GracePeriodRemaining
}
else{

    $LicenseStatus = "Puudub"
    $Grace = "Puudub"
}

# ==============================
# LISAINFOKS HTMLI JAOKS
# ==============================

$ADKasutajad = Get-ADUser -Filter * -ErrorAction SilentlyContinue |
Select-Object -ExpandProperty SamAccountName

$GPOList = Get-GPO -All -ErrorAction SilentlyContinue |
...
<p>Kuupaev: $(Get-Date)</p>
<p><b>Serveri nimi:</b> $Server</p>
<p><b>IP aadress:</b> $IP</p>
<p><b>AD domeen:</b> $DomainName</p>
<p><b>Forest nimi:</b> $ForestName</p>

<p><b>Kasutajad:</b> $($ADKasutajad -join ", ")</p>
<p><b>GPOd:</b> $($GPOList -join ", ")</p>

<p><b>Windows litsents:</b> $LicenseStatus</p>
<p><b>Grace period:</b> $Grace min</p>
